...
def test_generate_response():
    ...
    for section in result.response.get('sections', []):
        print(f"\n  Topic: {section.get('topic', 'N/A')}")
        
        print(f"  Answer Components:")
        for component in section.get('answer_components', []):
            print(f"    - {component}")
    ...
    print("\nGuardrails Applied:")
    for guardrail in result.guardrails.get('must_not_say', []):
        print(f"  - {guardrail}")
