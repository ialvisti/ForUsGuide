...
const ENGLISH_TO_SPANISH = new Map([
  ...
  ["Environment", "Entorno"],
  ["Account", "Cuenta"],
  ["Account and system status", "Cuenta y estado del sistema"],
  ...
  ["Actions", "Acciones"],
  ["Review", "Evaluar"],
  ["Tickets ready for evaluation, newest ready first.", "Tickets listos para evaluar, ordenados por disponibilidad más reciente."],
  ...
  ["No matches on this page; older executions remain", "No hay coincidencias en esta página; quedan ejecuciones anteriores"],
  ["Continue to the next page to search the remaining ready executions.", "Continúa a la página siguiente para buscar en las ejecuciones listas restantes."],
  ...
  ["The root-cause taxonomy this console adds. Use “Wrong route” when the answer took the wrong path with the information it already had.", "Taxonomía de causa raíz que agrega esta consola. Usa “Ruta equivocada” cuando la respuesta tomó el camino incorrecto con la información que ya tenía."],
  ...
  ["Fill this in when the answer scored below 5 and something had to change.", "Llena esto cuando la respuesta obtuvo menos de 5 y algo tuvo que cambiar."],
  ["It is what a later reviewer reads to find the change.", "Es lo que lee después otro revisor para encontrar el cambio."],
  ["What was done", "Qué se hizo"],
  ["What was modified", "Qué se modificó"],
  ["Every surface the fix touched. Choose “No change needed” alone when the observation was a misreading.", "Cada superficie que tocó el arreglo. Elige “No hacía falta cambiar nada” sola cuando la observación fue una mala lectura."],
